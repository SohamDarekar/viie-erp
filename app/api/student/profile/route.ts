  ...
  try {
    ...
    const updatedStudent = await prisma.student.update({
      ...
      data: {
        ...
        ...(data.schoolBoard !== undefined && { schoolBoard: data.schoolBoard }),
        ...(data.schoolBoardOther !== undefined && { schoolBoardOther: data.schoolBoardOther }),
        ...
        ...(data.highSchoolBoard !== undefined && { highSchoolBoard: data.highSchoolBoard }),
        ...(data.highSchoolBoardOther !== undefined && { highSchoolBoardOther: data.highSchoolBoardOther }),
