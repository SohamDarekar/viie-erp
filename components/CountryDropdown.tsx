...
const CountryDropdownComponent = forwardRef<HTMLButtonElement, CountryDropdownProps>(
  ...
  const triggerClasses = cn(
    "flex w-full items-center justify-between px-4 py-3 border rounded-xl bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500",
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        collisionPadding={10}
        side="bottom"
        className="min-w-[--radix-popper-anchor-width] p-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg"
      >
        <Command className="w-full max-h-[300px] sm:max-h-[400px] bg-white dark:bg-gray-800">
          <CommandList className="bg-white dark:bg-gray-800">
            <div className="sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
              <CommandInput placeholder="Search country..." className="bg-white dark:bg-gray-800" />
            </div>
